...
public:
   ...
   * @return true if both locations contain the same coordinate values, false
   * otherwise
   */
   ...
   *
   * @param other Comparison Location
   * @return true if both locations do not contain the same coordinate values,
   * false otherwise
   */
  bool operator!=(const Location &other) const {
    return x_ != other.x_ || y_ != other.y_;
  ...
  [[nodiscard]] std::string to_string() const {
    return std::format("Location(col: {}, row: {})", x(), y());
  }
