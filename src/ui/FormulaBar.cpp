...
void FormulaBar::createWidgets() {
    ...
    connect(m_formulaEdit, &QLineEdit::textChanged,
            this, &FormulaBar::formulaChanged);
    connect(m_formulaEdit, &QLineEdit::editingFinished,
            this, &FormulaBar::formulaEditingFinished);
    ...
    connect(m_expandButton, &QPushButton::clicked,
            this, &FormulaBar::onExpandClicked);
    ...
    connect(m_confirmButton, &QPushButton::clicked,
            this, &FormulaBar::onConfirmClicked);
    ...
    connect(m_cancelButton, &QPushButton::clicked,
            this, &FormulaBar::onCancelClicked);
}
...
void FormulaBar::onExpandClicked() {
    ...
    if (dialog.exec() == QDialog::Accepted) {
        ...
        m_formulaEdit->setText(QString::fromStdString(make_function(edited_formula)));
