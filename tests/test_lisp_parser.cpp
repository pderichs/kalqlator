...
void LispParserTests::nested_list() {
  ...
  checkCons(inner, {ExpectedType::t_symbol, "*", ExpectedType::t_number,
                    mpq_class(2), ExpectedType::t_number, mpq_class(3)});
}
...
void LispParserTests::quoted_list() {
  ...
  checkCons(quoted, {ExpectedType::t_number, 1, ExpectedType::t_number, 2,
                     ExpectedType::t_number, 3});
}
...
void LispParserTests::whitespace_handling() {
  ...
  QVERIFY(result);
  QVERIFY(result->is_cons());
  checkCons(result, {ExpectedType::t_symbol, "+", ExpectedType::t_number, 1,
                     ExpectedType::t_number, 2});
}

void LispParserTests::multiple_spaces() {
  LispObjectPtr result = parseString("(a    b    c)");
  QVERIFY(result);
  checkCons(result, {ExpectedType::t_symbol, "a", ExpectedType::t_symbol, "b",
                     ExpectedType::t_symbol, "c"});
}
...
void LispParserTests::arithmetic_expression() {
  ...
  checkCons(first_arg, {ExpectedType::t_symbol, "+", ExpectedType::t_number, 10,
                        ExpectedType::t_number, 20});

  LispObjectPtr second_arg = result->cdr()->cdr()->car();
  checkCons(second_arg, {ExpectedType::t_symbol, "-", ExpectedType::t_number, 5,
                         ExpectedType::t_number, 2});
}
...
void LispParserTests::function_call_with_nested_args() {
  ...
  checkCons(body, {ExpectedType::t_symbol, "*", ExpectedType::t_symbol, "x",
                   ExpectedType::t_symbol, "x"});
}
...
void LispParserTests::multiple_top_level_lists_parse_all() {
  ...
  auto item = result.front();
  checkCons(item, {ExpectedType::t_symbol, "+", ExpectedType::t_number, 1,
                   ExpectedType::t_number, 2});

  item = result[1];
  checkCons(item, {ExpectedType::t_symbol, "-", ExpectedType::t_number, 3,
                   ExpectedType::t_number, 4});
}
...
void LispParserTests::let_binding() {
  ...
  checkCons(first_binding,
            {ExpectedType::t_symbol, "x", ExpectedType::t_number, 1});

  // Second binding (y 2)
  LispObjectPtr second_binding = bindings->cdr()->car();
  checkCons(second_binding,
            {ExpectedType::t_symbol, "y", ExpectedType::t_number, 2});
...
void LispParserTests::cond_expression() {
  ...
  checkCons(first_condition,
            {ExpectedType::t_symbol, "<", ExpectedType::t_symbol, "x",
             ExpectedType::t_number, 0});
...
void LispParserTests::deeply_nested_arithmetic() {
  ...
  checkCons(second_product,
            {ExpectedType::t_symbol, "-", ExpectedType::t_number, 10,
             ExpectedType::t_number, 5});
  ...
  checkCons(second_part, {ExpectedType::t_symbol, "+", ExpectedType::t_number,
                          3, ExpectedType::t_number, 2});
}
